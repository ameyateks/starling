	...
	SavingGoals: []StarlingSavingSpace{
		StarlingSavingSpace{
			SavingsGoalUid: "def savings goal uid test",
			 ...
			 SavedPercentage: 0, SortOrder: 0, State: "Def Spending"}}, 
			 SpendingSpaces: []StarlingSpendingSpace{StarlingSpendingSpace{
				SpaceUid: "def space uid test", 
				Name: "Luxuries", SortOrder: 0, 
				State: "def state test", 
				SpendingSpaceType: "def spending space type test l", 
				CardAssociationUid: "def card association uid test", 
				Balance: SignedCurrencyAndAmount{Currency: "def currency test", 
				MinorUnits: 1234}},
				StarlingSpendingSpace{
					SpaceUid: "def space uid test", 
					Name: "Investments", SortOrder: 0, 
					State: "def state test", 
...
var transacationTestDataArr = []Transaction{
	{
		...
		Reference:                         "ref-1",
		Country:                           "US",
		SpendingCategory:                  getRandomCategory(),
